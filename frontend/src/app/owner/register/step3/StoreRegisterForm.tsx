...
export default function StoreRegisterForm({ onBack }: { onBack: () => void }) {
  const { category, address, description, accountNumber, storeImgUrl, setRegister, resetRegister } =
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <input
        ...
        className={`border p-2 rounded ${errors.accountNumber ? "border-red-500" : ""}`}
      />
