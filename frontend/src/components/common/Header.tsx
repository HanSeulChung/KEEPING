...
export default function Header() {
    return (
        <div className="w-full bg-white pt-2 sm:pt-3 md:pt-4">
            ...
            {/* 헤더 */}
            <header className="w-full h-12 sm:h-14 md:h-16 lg:h-18 flex items-center justify-between border-b border-l border-r border-black bg-white px-3 sm:px-4 md:px-6">
                {/* 뒤로가기 버튼 */}
                ...
                {/* 세로 구분선 */}
                <div className="h-6 sm:h-8 md:h-10 border-l border-black"></div>

                {/* Center: Logo */}
                <span className="font-extrabold text-sm sm:text-base md:text-lg lg:text-xl text-black" style={{ fontFamily: 'var(--font-tenada)' }}>KEEPING</span>
