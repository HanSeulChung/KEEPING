    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-['Tenada'] font-extrabold text-black text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/owner/register"
              className="flex items-center justify-center w-12 h-12 rounded-full border border-gray-300 bg-white hover:bg-gray-50 transition-colors"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="text-sm sm:text-base font-['nanumsquare'] text-black leading-relaxed">
              전체 선결제 금액<br />
              이번 달 선결제 금액
            </div>
          </Link>
          ...
          <Link
            ...
            className="group p-6 border border-black bg-white hover:bg-gray-50 transition-colors sm:col-span-2"
          >
            ...
            <div className="text-sm sm:text-base font-['nanumsquare'] text-black">
              읽지 않은 알림<br />
              3건
            </div>
          </Link>
